  ...
  return (
    ...
    >
      ...
      <p style={{ color: 'var(--text-secondary)', textAlign: 'center', fontSize: '1rem', lineHeight: 1.65, marginBottom: 36 }}>
        Introdu email-ul pentru a debloca rezultatele și recomandările complete de automatizare.
      </p>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div>
          <input
            ...
            onFocus={e => { if (!error) e.target.style.borderColor = 'rgba(37,99,235,0.6)'; }}
